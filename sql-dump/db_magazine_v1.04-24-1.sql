...
--
-- Table structure for table `flat_planning_table`
--

DROP TABLE IF EXISTS `flat_planning_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `flat_planning_table` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `flat_planning_table`
--

LOCK TABLES `flat_planning_table` WRITE;
/*!40000 ALTER TABLE `flat_planning_table` DISABLE KEYS */;
INSERT INTO `flat_planning_table` VALUES (157,'kpa','PILE DRIVER','S Company 1','page_back_inside','drag_1','SMALL',708,142,1,2,'2017-04-20 09:35:29','2017-04-20 09:35:29'),(158,'kpa','PILE DRIVER','H Company 11','page_back_inside','drag_11','HALF_Y',701,205,1,2,'2017-04-20 09:35:38','2017-04-20 09:35:38'),(159,'kpa','PILE DRIVER','H Company 11','page_back_inside','drag_11','HALF_Y',693,116,1,2,'2017-04-20 09:37:09','2017-04-20 09:37:09'),(160,'kpa','PILE DRIVER','S Company 1','page_back_inside','drag_1','SMALL',701,233,1,2,'2017-04-20 09:37:14','2017-04-20 09:37:14'),(161,'kpa','PILE DRIVER','H Company 11','page_back_inside','drag_11','HALF_Y',692,221,1,2,'2017-04-20 09:37:23','2017-04-20 09:37:23'),(162,'kpa','PILE DRIVER','S Company 9','page_back_inside','drag_9','SMALL',714,134,1,2,'2017-04-20 09:37:32','2017-04-20 09:37:32'),(163,'kpa','File Driver','S Company 9','page_back_inside','drag_9','SMALL',703,139,1,2,'2017-04-20 09:37:33','2017-04-20 09:37:33'),(164,'kpa','File Driver','S Company 9','page_back_inside','drag_9','SMALL',735,131,1,2,'2017-04-20 09:37:35','2017-04-20 09:37:35'),(165,'kpa','PILE DRIVER','H Company 11','page_back_inside','drag_11','HALF_Y',699,121,1,2,'2017-04-20 09:37:37','2017-04-20 09:37:37');
/*!40000 ALTER TABLE `flat_planning_table` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-04-24 21:14:04

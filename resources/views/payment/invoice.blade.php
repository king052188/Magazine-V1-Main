...
@section('magazine_content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <strong>List of all Print Invoices</strong>
                </li>
            </ol>
        </div>
    </div>
                                ...
                                <div class="col-sm-12 form-inline">
                                    ...
                                    <div class="" id = "filter_container">
                                        <div class="form-group imp_display" style="margin-right: 10px;">
                                            ...
                                            <select class="form-control chosen-select" style="background-color: #2f4050; color: #FFFFFF; height: 35px;" name = "company_name" id = "company_name">
                                        ...
                                        <div class="form-group" style="margin-right: 10px;">
                                            ...
                                            <select class="form-control chosen-select" style="background-color: #2f4050; color: #FFFFFF; height: 35px;" name = "magazine_name" id = "magazine_name">
                                                <option value="0">Select</option>
                                        ...
                                        <div class="form-group" style="margin-right: 10px;">
                                            ...
                                            <select class='form-control' name='generate_year' id = 'generate_year' style="background-color: #2f4050; color: #FFFFFF; width: 150px; height: 35px;" required>
                                                <option value="0">Select</option>
                                        ...
                                        <div class="form-group" style="margin-right: 10px;">
                                            ...
                                            <select class='form-control' name='generate_issue' id = 'generate_issue' style="background-color: #2f4050; color: #FFFFFF; width: 100px; height: 35px;" required>
                                                <option value="0">Select</option>
                                                @for($i = 1; $i < 13; $i++)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary filter-col " id = "btn_generate" style="margin-bottom: 0px; height: 35px; padding: 0 10px 0 5px;">
